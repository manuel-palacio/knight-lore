...
export function buildHallLights(): THREE.Object3D[] {
  const moon = new THREE.SpotLight(0x8aa0c8, 2.6, 35, Math.PI / 3.5, 0.5, 1.3)
  ...
  const hemi = new THREE.HemisphereLight(0x6080a0, 0x4a2818, 0.7)
  ...
  // Tiny cool ambient as the absolute floor.
  const ambient = new THREE.AmbientLight(0x404858, 0.15)
