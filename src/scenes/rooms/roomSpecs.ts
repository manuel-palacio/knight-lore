...
export const ROOM_SPECS: RoomSpec[] = [
  ...
  },
  {
    ...
    spawn: { x: 4, z: 1 },
    platforms: [],
    spikes: [{ x: 1, z: 1 }, { x: 2, z: 3 }, { x: 3, z: 4 }, { x: 4, z: 4 }, { x: 5, z: 2 }],
    ghosts: [{ x: 3, z: 3 }],
  },
  {
    id: 'map-1-0', tint: 'blue', mapped: true,
  ...
  },
  {
    ...
    spawn: { x: 4, z: 1 },
    platforms: [],
    spikes: [{ x: 0, z: 0 }, { x: 2, z: 1 }, { x: 3, z: 3 }, { x: 3, z: 5 }, { x: 4, z: 2 }, { x: 5, z: 4 }, { x: 5, z: 6 }],
  ...
  },
  {
    ...
    exits: [{ direction: 'north', target: 'map--2-0' }, { direction: 'east', target: 'map--1-1' }, { direction: 'west', target: 'map--3-1' }],
    spawn: { x: 4, z: 1 },
    platforms: [],
  ...
  },
  {
    ...
    exits: [{ direction: 'west', target: 'map--2-4' }],
    spawn: { x: 4, z: 1 },
    platforms: [{ x: 6, z: 6, height: 1 }, { x: 7, z: 5, height: 2 }],
    spikes: [{ x: 7, z: 7 }],
    pickups: [{ x: 5, z: 7, item: 'wine-bottle' }],
  },
  {
    id: 'map--4-1', tint: 'purple', mapped: true,
  ...
  },
  {
    ...
    spawn: { x: 4, z: 1 },
    platforms: [{ x: 7, z: 7, height: 1 }],
    spikes: [{ x: 4, z: 2 }, { x: 6, z: 3 }, { x: 6, z: 7 }, { x: 7, z: 2 }],
  },
  {
  ...
  },
  {
    ...
    exits: [{ direction: 'north', target: 'map--4-3' }, { direction: 'south', target: 'map--4-5' }, { direction: 'east', target: 'map--3-4' }, { direction: 'west', target: 'map--5-4' }],
    spawn: { x: 4, z: 1 },
    platforms: [],
  },
  {
  ...
  },
  {
    ...
    spawn: { x: 4, z: 1 },
    platforms: [{ x: 3, z: 4, height: 1 }, { x: 4, z: 4, height: 2 }, { x: 4, z: 5, height: 2 }],
    spikes: [{ x: 2, z: 3 }, { x: 2, z: 4 }, { x: 3, z: 5 }, { x: 4, z: 2 }, { x: 5, z: 2 }, { x: 5, z: 4 }],
    pickups: [{ x: 3, z: 3, item: 'gem' }],
  },
  {
    id: 'map--4-6', tint: 'purple', mapped: true,
    exits: [{ direction: 'north', target: 'map--4-5' }],
    spawn: { x: 4, z: 1 },
    platforms: [],
    spikes: [{ x: 1, z: 3 }, { x: 1, z: 4 }, { x: 1, z: 6 }, { x: 2, z: 2 }, { x: 3, z: 4 }, { x: 4, z: 2 }, { x: 4, z: 4 }, { x: 5, z: 5 }, { x: 5, z: 7 }, { x: 6, z: 1 }, { x: 6, z: 2 }, { x: 7, z: 4 }, { x: 7, z: 6 }],
    pickups: [{ x: 3, z: 3, item: 'crystal-ball' }],
  },
  {
    id: 'map--7-4', tint: 'green', mapped: true,
    exits: [{ direction: 'east', target: 'map--6-4' }],
    spawn: { x: 4, z: 1 },
    platforms: [],
    spikes: [{ x: 0, z: 3 }],
